...
Thus far I have worked exclusively with R, though I plan to begin learning Python in the coming months in order to gain experience with machine learning. In the meantime, I am currently completing the "SQL Fundamentals" course in the "Data Analyst in R" path on <dataquest.io> and will move on shortly to the "Intermediate SQL in R" course.  
